...
namespace SchoolManagementApp.MVC.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code,Credots")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code,Credots")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
